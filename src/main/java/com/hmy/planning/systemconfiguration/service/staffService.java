...
// {
// Optional<orgStructure> orgStructure =
// orgServices.getOrgStructureID(reqStaff.getOfficeID());
...
// String FullName = staff.getFirstname() + " " + staff.getMiddlename() + " " +
// staff.getLastname();
...
// + "The following are your platform credentails.Dont forget to change the
// Password"
