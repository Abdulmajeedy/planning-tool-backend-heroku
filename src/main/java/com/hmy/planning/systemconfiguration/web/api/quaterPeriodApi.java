...
public interface quaterPeriodApi {
        ...
        public ResponseEntity<quaterPeriodResponseDto> getQuaterPeriodById(
                        @PathVariable("quaterPeriodCode") String reqQuaterPeriod);

        @DeleteMapping(path = "/{quaterPeriodCode}")
        @ResponseStatus(code = HttpStatus.OK, reason = "Project Deleted")
        public void deleteById(@PathVariable("quaterPeriodCode") String quaterPeriodCode);
        ...
        @RequestMapping(value = "updateStatus/{quaterPeriodCode}", method = RequestMethod.GET)
        public ResponseEntity updateStatus(@PathVariable("quaterPeriodCode") String quaterPeriodCode);
